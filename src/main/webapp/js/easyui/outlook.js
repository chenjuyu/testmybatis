...
function addNav(data) {
	...
	$.each(data, function(i, sm) {
		var menulist = "";
		var sclick ="";
		//var sclick ="onclick=addTab('baidu',+'http://www.baidu.com','#')";
		menulist += '<ul>';
		$.each(sm.menus, function(j, o) { //href="http://127.0.0.1:8080/testmybatis/possales/index.do" 
			menulist += '<li><div><a ref="' + o.menuid + '"  rel="'
					+o.url+' " '+sclick+'> <span class="icon ' + o.icon
