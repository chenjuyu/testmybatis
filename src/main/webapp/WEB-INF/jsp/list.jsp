...
<title>Insert title here</title>
 ...
 $(function(){ 
    $('#tt').datagrid({
    	url:"<%=basePath%>possales/listdata.do",
    	fit:true,//自动适应边距
    	rownumbers :"true" ,
 ...
 $("#BeginDate").datebox("setValue","2016-01-01");
...
<div region="north" split="true" class="easyui-accordion"  border="false" style="overflow: hidden; height: auto;">
 ...
 <div style="margin-bottom:5px">
  ...
  <form id="form1">
    <span>日期</span>
    <input id="BeginDate" name="BeginDate" type="text" class="easyui-datebox" required="required" >-
    <input id="EndDate" name="EndDate" type="text" class="easyui-datebox" required="required" >
	<span>部门:</span>
	<input id="DepartmentID" name="DepartmentID" style="line-height:26px;border:1px solid #ccc">
	<span>货品:</span>
