...
[//{"type":"checkbox","width":50},
 ...
 {"field":"price","title":"商品金额","width":150,totalRow: true},
 {"field":"quantity","title":"下单数量","width":150,totalRow: true}
...
[//{"type":"checkbox","width":50},
 ...
 $.ajax({ 
	 url:'<%=basePath%>stock/orderqueryOrder.html',
     type:'post',
     ...
     success:function(res){
    	 ...
    	 $('#poOrderNo').val(res.attribute.eclpSoNo)
    	 $('#isvPoOrderNo').val(res.attribute.isvUUID)
    	 $('#supplierNo').val(res.attribute.shipperName)
    	 table.render({
    		 elem: '#test'
    		 ,title: '详情数据表'
    		 ,id: 'selectlist'
