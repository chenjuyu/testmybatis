...
[//{"type":"checkbox","width":50},
 {"field":"deptGoodsNo","title":"京东商品编码","width":150},
 {"field":"goodsName","title":"京东商品名称","width":150},
 {"field":"quantity","title":"申请出库数量","width":150,totalRow: true},
 {"field":"realQuantity","title":"实际出库数量","width":150,totalRow: true},
 {"field":"goodsStatus","title":"商品状态(良品；残品；样品)","width":150},
 {"field":"goodsLevel","title":"商品等级","width":150},
...
[//{"type":"checkbox","width":50},
 ...
 $.ajax({ 
	 url:'<%=basePath%>stock/rtsisvRtsQuery.html',
     type:'post',
     data:{'No':No},
     dataType:'json',
     cache:false,
     success:function(res){
    	 ...
    	 $('#poOrderNo').val(res.attribute.eclpRtsNo)
    	 $('#isvPoOrderNo').val(res.attribute.isvRtsNum)
