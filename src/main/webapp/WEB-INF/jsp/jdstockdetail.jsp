                             ...
                             <!--   <label>仓库： </label>   <div class="layui-inline layui-show-xs-block">
                              ...
                              <label>京东单号： </label>
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="poOrderNo" id="poOrderNo" placeholder="" autocomplete="off" class="layui-input">
                               </div>
                             <label>伏羲单号： </label>
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="isvPoOrderNo" id="isvPoOrderNo" placeholder="" autocomplete="off" class="layui-input">
                               </div>
                              <label>京东厂商编码： </label>
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="supplierNo" id="supplierNo" placeholder="" autocomplete="off" class="layui-input">
                               </div>  
...
<!-- 注意：如果你直接复制所有代码到本地，上述js路径需要改成你本地的   <div class="selectcontent"><ul></ul></div>--> 
...
layui.use(['element','table','laydate','form','autocomplete'], function(){
  ...
  var conditions=layui.data('conditions')
  var obj=layui.data('obj')
  
 
  
  var department=conditions.conditions
  var DisplaySizeGroup=''
...
[//{"type":"checkbox","width":50},
 {"field":"goodsNo","title":"京东商品编码","width":150},
 {"field":"numApplication","title":"申请入库数量","width":150,totalRow: true},
 {"field":"realInstoreQty","title":"实际入库数量","width":150,totalRow: true},
 {"field":"shortQty","title":"缺货数量","width":150,totalRow: true},
 {"field":"damagedQty","title":"包装破损数量","width":150,totalRow: true},
 {"field":"emptyQty","title":"空盒数量","width":150,totalRow: true},
 {"field":"expiredQty","title":"超保数量","width":150,totalRow: true},
 {"field":"otherQty","title":"其他差异数量","width":150,totalRow: true},
 {"field":"goodsDamagedQty","title":"实物破损数量","width":150,totalRow: true},
 {"field":"deformedQty","title":"变形数量","width":150,totalRow: true},
 {"field":"errorQty","title":"错货数量",totalRow: true},
 {"field":"excessQty","title":"多货数量",totalRow: true},
 {"field":"barcodeScanFailQty","title":"条码无法扫描数量","width":150,totalRow: true},
 {"field":"expirationDateErrorQty","title":"保质期维护错误数量","width":100,totalRow: true},
 {"field":"barcodeErrorQty","title":"条码维护错误数量","width":100,totalRow: true},
 {"field":"pollutionQty","title":"污染数量","width":100,totalRow: true},
 {"field":"markUnclearQty","title":"标识不清","width":100,totalRow: true},
 {"field":"remark","title":"差异备注","width":100}
 ]]
 var cols2=	 [
[//{"type":"checkbox","width":50},
 {"field":"goodsName","title":"商品名称","width":150},
 {"field":"goodsNo","title":"商品编号","width":80},
 {"field":"sellerGoodsSign","title":"商家商品标识"},
 {"field":"serialNo","title":"序列号"},
 {"field":"unQualifiedQty","title":"数量",totalRow: true},
 {"field":"checkResultStr","title":"质检结果"},
 {"field":"errReason","title":"不合格原因"},
 {"field":"qcTimeStr","title":"质检时间"}
 
 ]]
 //"colGroup":true   这种解决多出重复列的问题，我还是引用 原来 的自己的方式，改变title 即可，不用再生成的重复列了
 var tblNo=layui.data('No')
 var No=tblNo.No
 console.log("京东的单号："+No)
 $.ajax({ 
	 url:'<%=basePath%>stock/queryPoOrder.html',
     type:'post',
     data:{'No':No},
     dataType:'json',
     cache:false,
     success:function(res){
    	 ...
    	 $('#poOrderNo').val(res.attribute.poOrderNo)
    	 $('#isvPoOrderNo').val(res.attribute.isvPoOrderNo)
    	 $('#supplierNo').val(res.attribute.supplierNo)
    	 table.render({
    		 elem: '#test'
    	  ...
    	  table.render({
    		 ...
    		 ,title: '详情数据表'
    		 ,id: 'selectlist2'
    	     ,data:res.attribute.qcBackErrItemList
    	     ,cols:cols2//res.cols //
    	     ,totalRow: true
    	     ,page: true
    	     ,limit:10
